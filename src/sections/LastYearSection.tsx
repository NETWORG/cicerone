      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-asphalt-300 text-base max-w-2xl mx-auto">
            Last summer we spent a week driving through Poland, Lithuania, and Latvia — roughly 3,000 km across
            the Baltics in questionable cars. The route was great. The cars were worse. The experience was good enough
            that we decided to make it annual and invite more people.
          </p>
        </div>
