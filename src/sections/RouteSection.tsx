    ...
    <section id="route" className="section-pad bg-asphalt-900">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-10">
          ...
          {/* Country flags row */}
          <div className="flex flex-wrap justify-center items-center gap-x-5 gap-y-3 mt-6 mb-2">
            {COUNTRIES.map((code) => {
              const Flag = (Flags as Record<string, React.ComponentType<React.SVGProps<SVGSVGElement>>>)[code];
              return (
                <span key={code} className="flex items-center gap-2 group relative" title={COUNTRY_NAMES[code]}>
                  {Flag && (
                    <Flag
