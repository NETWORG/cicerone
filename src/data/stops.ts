...
export const STOPS: Stop[] = [
  ...
  {
    id: 'overnight-genoa',
    name: 'Overnight - Big Bench #233, Campomorone',
    location: 'Campomorone, Genoa, Italy',
    country: 'IT',
    category: 'sleep',
    coords: { lat: 44.55017805750934, lng: 8.888043782117094 },
    date: 'Tue, 21 Jul 2026',
    time: '21:30',
    blurb:
      "Fourth night's camp beside Big Bench #233, one of the giant wooden benches from the Big Bench Community Project, looking out over the hills above Genoa.",
    link: 'https://bigbenchcommunityproject.org/',
    driveFromPrevious: { distanceKm: 83.5, durationMin: 75 },
  },
  {
    id: 'pesto',
    ...
    driveFromPrevious: { distanceKm: 31.8, durationMin: 53 },
  },
  {
    id: 'olive-oil',
    ...
    driveFromPrevious: { distanceKm: 77.8, durationMin: 60 },
  },
  {
    id: 'monaco',
    name: 'Monaco',
    ...
    driveFromPrevious: { distanceKm: 101.0, durationMin: 80 },
  },
  {
    id: 'plage-des-marinieres',
    name: 'Plage des Mariniéres',
    location: 'Villefranche-sur-Mer, Alpes-Maritimes, France',
    country: 'FR',
    category: 'sea',
    coords: { lat: 43.70378790525401, lng: 7.320259299906325 },
    date: 'Wed, 22 Jul 2026',
    time: '18:45',
    blurb:
      'A change of beach plan - a dip at this sandy bay in Villefranche-sur-Mer, just along the coast from Monaco, before the drive on to Saint-Tropez.',
    driveFromPrevious: { distanceKm: 17.8, durationMin: 33 },
  },
  {
  ...
  {
    id: 'annecy-overnight',
    name: 'Overnight - Annecy Lakeside',
    location: '7 Rte du Semnoz, 74000 Annecy, France',
    country: 'FR',
    category: 'sleep',
    coords: { lat: 45.8841922, lng: 6.1344726 },
    date: 'Fri, 24 Jul 2026',
    time: '23:30',
    blurb:
      "After the Tour de France finish, an impromptu drive to camp by the lake in Annecy instead of heading back to base - one of the most beautiful lakes in Europe under the stars.",
    driveFromPrevious: { distanceKm: 171.5, durationMin: 136 },
  },
  {
    id: 'cern',
    ...
    driveFromPrevious: { distanceKm: 52.0, durationMin: 48 },
  },
  {
    id: 'prague-finish',
    name: 'Prague - Finish',
    ...
    time: '04:00',
    blurb:
      "Straight through to the finish: left CERN at 15:00 and drove overnight via Zurich and Munich, no more stops, arriving back in Prague at 4am - Furka Pass, the Mercedes-Benz Museum and Sinsheim all sacrificed for the road home. Cars limp home, stories are told, and plans are quietly made for next year.",
    driveFromPrevious: { distanceKm: 968.6, durationMin: 608 },
  },
];
